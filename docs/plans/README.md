...
| 5 | 视觉升级与体验打磨 | Zustand 状态管理 + 物体嘴型叠加 + 表情眼动 + 内置场景图库 | 嘴巴长在物体上、自然眨眼、免拍照上手、架构整洁 | ✅ 已完成:`2026-05-11-phase-5-visual-polish.md` |
| 6 | 国产 AI 厂商接入 | 适配层 + 人物声音映射 | 不依赖 OpenAI 也能跑;每个物体有专属嗓音 | ✅ 已完成:`2026-05-12-phase-6-domestic-providers.md` |
